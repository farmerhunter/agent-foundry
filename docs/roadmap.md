...
| ORCH-01 + ORCH-02 + ORCH-03 + ORCH-04 | `v2.0.0` candidate: local-first Board, SQLite ledger storage/replay, distributed authority, selective sync, integrated onboarding/status/recovery/front door and final readiness evidence. Release requires a separate Human gate. |
...
The ORCH sequence is the active product-development target. ORCH-01 and ORCH-02 are complete; ORCH-03 retains the distributed-authority/selective-sync order, while ORCH-04 owns the integrated lifecycle and product experience. The four milestones jointly target a `v2.0.0` candidate, but release remains a separate final-readiness/Human gate.
...
| ORCH-01 Local-First Orchestration And Foundry Board | #292 (closed historical Epic); #293 through #299; #359 through #362; #266 telemetry window | Users need a local source of truth for multi-agent orchestration. | Completed; historical V2.0 mapping retained |
| ORCH-02 SQLite Local Ledger Foundation | #525 Epic; #526 through #530 | Users need one durable, transactional local ledger for onboarding, replay, Board reads, local actions, and recovery. | Completed technical/adopter readiness; release remains a separate gate |
| ORCH-03 Distributed Authority And Selective Sync | #400 Epic; #401, #522, #404, #405, #403, #521, #402, #406 | Users need bounded local authority and selective external materialization after the SQLite foundation is ready. | Planned/held; original order retained |
| ORCH-04 Integrated Collaboration Lifecycle And Product Experience | #538 Epic; #539–#543; #536 as ORCH-04-5 | Users need one coherent onboarding, daily Work, status, recovery, device and front-door experience over the ORCH foundations. | Planned; ORCH-04-0 design first |
...
| Stage | AF-1 through AF-15, V1.0, V2.0, MS-01, MS-02 | Maturity, release-readiness, product-version, or memory-system planning stage the item serves. |
...
- `stage:AF-1` through `stage:AF-15`
