...
| AF-18 Collaboration Cost-Control And Control Plane | #439 through #452 | Users need multi-agent collaboration to stay useful without runaway context, hidden token growth, duplicated dispatches, or opaque human attention feeds. | Active bounded lane; #450 accepted; #451/#452 gated |
