...
| V2-8 Capability Replan And Operational UX Contract | #369 | Redefine V2 completion around the full operation chain: capability layer, interfaces, data contracts, apply, sync, mixed-state recovery, dogfood, and enablement. | Accepted design |
